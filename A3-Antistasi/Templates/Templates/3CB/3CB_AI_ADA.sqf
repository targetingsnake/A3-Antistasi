...
_loadoutData set ["offhat", ["UK3CB_ADA_B_H_Off_Beret"]];
...
_sfLoadoutData set ["snihat", ["UK3CB_ADA_B_H_BoonieHat_TTC"]];
...
_militiaLoadoutData set ["snihat", ["UK3CB_ADA_B_H_BoonieHat_CC"]];
