...
_sfLoadoutData set ["offuniforms", ["U_O_R_Gorka_01_F"]];
...
_militaryLoadoutData set ["offuniforms", ["U_O_T_Officer_F"]];
...
_militiaLoadoutData set ["offuniforms", ["U_O_T_Officer_F"]];
