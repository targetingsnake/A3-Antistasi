...
_sfLoadoutData set ["Offvests", ["rhs_6b5_officer"]];
...
_militaryLoadoutData set ["Offvests", ["rhs_6b5_officer_ttsko"]];
...
_militiaLoadoutData set ["Offvests", ["rhs_6b5_officer_khaki"]];
