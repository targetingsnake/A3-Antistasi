/*
Author: Bob Murphy
    Creates a thermobaric particle effect at target location.
    ...
    Not safe to eat. Certainly causes cancer and multiple other side-effects.
...
Example:
    [screenToWorld [0.5,0.5], true] call A3A_fnc_thermobaricParticles;  // Spawn thermobaric particles at the terrain position you are looking at.
*/

private _filename = "functions\bombs\fn_thermobaricParticles.sqf";
