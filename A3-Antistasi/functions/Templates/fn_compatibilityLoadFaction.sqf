...
//compile collection list of vehicles
_faction setVariable ["vehiclesLight", (_faction getVariable "vehiclesLightArmed") + (_faction getVariable "vehiclesLightUnarmed")];
_faction setVariable ["vehiclesAttack", (_faction getVariable "vehiclesAPCs") + (_faction getVariable "vehiclesTanks")];
_faction setVariable ["vehiclesBoats", (_faction getVariable "vehiclesGunboats") + (_faction getVariable "vehiclesTransportBoats")];
_faction setVariable ["vehiclesNormal",
    (_faction getVariable "vehiclesLight")
    + (_faction getVariable "vehiclesTrucks")
...
_faction setVariable ["vehiclesAir",
    (_faction getVariable "vehiclesHelisLight")
    + (_faction getVariable "vehiclesHelisTransport")
    + (_faction getVariable "vehiclesPlanesCAS")
    + (_faction getVariable "vehiclesPlanesAA")
    + (_faction getVariable "vehiclesPlanesTransport")
];
