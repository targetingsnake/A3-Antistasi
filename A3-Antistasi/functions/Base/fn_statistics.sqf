...
//waitUntil {!isNull (uiNameSpace getVariable "A3A_StatusBar")};
if (isNull (uiNameSpace getVariable "A3A_StatusBar")) exitWith {};
_display = uiNameSpace getVariable "A3A_StatusBar";
