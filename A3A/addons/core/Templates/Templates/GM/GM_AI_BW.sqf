...
_militiaLoadoutData set ["uniforms", ["gm_ge_pol_uniform_suit_80_grn", "gm_ge_pol_uniform_blouse_80_blk"]];
_militiaLoadoutData set ["vests", ["gm_ge_army_vest_80_belt", "V_TacVest_blk", "V_BandollierB_blk", "V_Chestrig_blk"]];
